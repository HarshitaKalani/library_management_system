...
// class VerifyUpdatePassword extends StatefulWidget {
//   // const VerifyUpdatePassword({Key? key}) : super(key: key);
//   final String otp;
//   final String email;

//   @override
//   _VerifyUpdatePasswordState createState() => _VerifyUpdatePasswordState();
//   VerifyUpdatePassword({required this.otp, required this.email});
// }

// class _VerifyUpdatePasswordState extends State<VerifyUpdatePassword> {
...
//       }
//       _resentCode = code;
//       await sendMail(FirebaseAuth.instance.currentUser.email,
...
//           print("hereItIs");
//           _isResendAgain = true;
//           FirebaseAuth.instance.currentUser.updatePassword(widget.email).then(
//                 (value) => {print("Password Update")},
//               );
